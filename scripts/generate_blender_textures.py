...
def setup_render_env():
    ...
    # CRITICAL FIX: Strict 8-bit PNG for Bedrock Mobile Compatibility
...
def clean_old_files():
    # Adding the old broken vanilla feature overrides to the kill list
    bad_files = [
        'behavior_pack/features/oak_tree_feature.json',
        'behavior_pack/features/birch_tree_feature.json',
        'behavior_pack/features/fancy_tree_feature.json'
    ]
